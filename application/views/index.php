...
<body>
    <nav class="navbar navbar-expand-sm bg-light navbar-light fixed-top">
        ...
        <form class="d-flex">
            <a href="login"><button class="btn btn-light me-3" type="button">Login</button></a>
            <a href="signup"><button class="btn me-2" style="background-color:#E74E35; color:white;" type="button">Signup</button></a>
        </form>
        </div>
    </nav><br><br><p></p><br><br>
    <div class="container-fluid">
        ...
        <center><a href="signup"><button class="btn mt-2 mb-3"style="background-color:#E74E35; color:white;" type="button">Signup for free</button></a></center><hr class="ms-1 me-1">
    </div>
    ...
    <center><p class="h1" style="color:#E74E35;"><b>Taskify</b>&nbsp;&nbsp;<a href="login"><button class="btn btn-outline-dark btn-sm me-3" style="width:80px" type="button">Login </button></a></p></center><br>
    </div>
</body>
</html>